...
<a data-sveltekit-preload-data="hover" href="/end_user_messages">
	<button>Messages (End User)</button>
</a>
<a data-sveltekit-preload-data="hover" href="/messages">
	<button>Messages (Technician)</button>
</a>
<button data-sveltekit-preload-data="hover" on:click={handlePing}>Send Test Ping</button>
